 ...
 * 
 * Esta ventana es el punto de entrada visual de la aplicación después del
 * main().
 ...
 * 
 * Extiende javax.swing.JFrame para crear una ventana de aplicación de
 * escritorio.
 * Usa el sistema de layouts de Swing (GroupLayout) para organizar los
 * componentes.
 * 
...
public class iLogin extends javax.swing.JFrame {
   ...
   */
  public iLogin() {
    // Llama al método generado automáticamente que configura todos los componentes
    // visuales
    // Este método fue creado por el editor visual de NetBeans y configura botones,
    // eventos, etc.
    initComponents();

    // Maximiza la ventana para que ocupe toda la pantalla
    // MAXIMIZED_BOTH es una constante de java.awt.Frame que indica maximización
  ...
  /**
   * Método generado automáticamente que inicializa todos los componentes de la
   * interfaz.
   ...
   * 
   * Se ejecuta automáticamente cuando el usuario hace clic en el botón
   * "Invitado".
   * Realiza la navegación desde la pantalla de login hacia la pantalla de
   * selección
   * de eventos para invitados (iInvitado).
   * 
   * @param evt Objeto ActionEvent de java.awt.event que contiene información del
   *            evento de clic
   */
  private void btnInvitadoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnInvitadoActionPerformed
    // Crear una nueva instancia de la clase iInvitado (ventana de selección de
    // eventos)
  ...
  /**
   * Manejador de evento (ActionListener) para el botón "Administrador de
   * Eventos".
   * 
   * Se ejecuta automáticamente cuando el usuario hace clic en el botón
   ...
   * Realiza la navegación desde la pantalla de login hacia la pantalla de
   * administración
   * de eventos (iAdminEvento), donde se pueden crear eventos y gestionar
   * registros.
   * 
   * @param evt Objeto ActionEvent de java.awt.event que contiene información del
   *            evento de clic
  ...
  private void btnAdminEventActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAdminEventActionPerformed
    // Crear una nueva instancia de la clase iAdminEvento (ventana de
    // administración)
    // iAdminEvento es otra clase JFrame del paquete
    // com.mycompany.gestionformulario2
  ...
  private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSalirActionPerformed
    // Mostrar un cuadro de diálogo modal de confirmación usando JOptionPane de
    // javax.swing
    // showConfirmDialog() muestra una ventana con botones Sí/No y devuelve la
    // opción seleccionada
    ...
    // YES_OPTION es una constante de JOptionPane que representa la opción
    // afirmativa
    ...
    // Si el usuario hace clic en "No", el método termina sin hacer nada y la
   ...
   * de los hilos al crear componentes gráficos. Swing no es thread-safe, por lo
   * que
  ...
  public static void main(String args[]) {
    ...
    // EventQueue es una clase de java.awt que gestiona eventos de la interfaz
    // gráfica
