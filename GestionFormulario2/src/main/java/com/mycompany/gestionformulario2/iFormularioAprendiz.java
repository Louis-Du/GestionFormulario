...
public class iFormularioAprendiz extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(iFormularioAprendiz.class.getName());
    ...
    txtFicha.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            ...
            if (!Character.isDigit(c) && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten números en el campo Ficha.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    txtCelular.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            char c = evt.getKeyChar();
            if (!Character.isDigit(c) && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten números en el campo Celular.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    
    // (Opcional) También deberías hacer lo mismo para txtNumdocum si es solo numérico
    txtNumdocum.addKeyListener(new java.awt.event.KeyAdapter() {
        @Override
        public void keyTyped(java.awt.event.KeyEvent evt) {
            char c = evt.getKeyChar();
            if (!Character.isDigit(c) && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten números en el campo Número de Documento.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    txtNomapren.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            ...
            if (!Character.isLetter(c) && c != ' ' && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten letras y espacios en el campo Nombre y Apellido.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    txtPrograma.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            char c = evt.getKeyChar();
            if (!Character.isLetter(c) && c != ' ' && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten letras y espacios en el campo Programa.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    txtCentro.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            char c = evt.getKeyChar();
            if (!Character.isLetter(c) && c != ' ' && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten letras y espacios en el campo Centro.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    txtCorreo.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            ...
            if (!Character.isLetter(c) && c != ' ' && c != '@' && c != '.' && c != '\b') {
                JOptionPane.showMessageDialog(iFormularioAprendiz.this, "Solo se permiten letras, espacios, @ y . en el campo Correo.", "Error", JOptionPane.ERROR_MESSAGE);
                evt.consume();
            }
        }
    });
    ...
    private void initComponents() {
        ...
        cbTipodocum.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula de Ciudadania", "Tarjeta de Identidad", "Cédula de Extranjería" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtNumdocum, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtPrograma, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(layout.createSequentialGroup()
                            .addGap(83, 83, 83)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtFicha, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txtNomapren, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(149, 149, 149)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(txtNomapren, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(cbTipodocum, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtNumdocum, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    // Aunque ya bloqueamos las letras con el KeyListener, es bueno tener doble seguridad
