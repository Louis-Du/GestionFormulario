...
/**
 * Clase utilitaria para exportar registros de asistentes a formato Excel (.xlsx).
 * 
 ...
 * 
 * Utiliza la biblioteca Apache POI (versión 5.5.1) para la manipulación de archivos Excel.
 * Los archivos generados son compatibles con Microsoft Excel 2007 y versiones posteriores.
 * 
...
public class ExportadorExcel {
     ...
     * 
     * @param registros Lista de objetos Registro con los datos de los asistentes a exportar
